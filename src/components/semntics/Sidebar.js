    ...
    >
      ...
      <div>
        ...
        <details className="relative">
          <summary
            className={`cursor-pointer flex items-center list-none ${
          ...
          >
            <span className="flex items-center ml-2">
              ...
              <span className="text-custom-16 ml-4">Vendor </span>
            </span>
          </summary>

          {/* Dropdown Menu */}
          <div className="absolute left-0 mt-2 w-40 bg-white border rounded-lg shadow-md">
            <ul className="py-2 text-gray-700">
              ...
              <li
                className="px-4 py-2 hover:bg-gray-200 cursor-pointer"
                onClick={() => navigate("/vendorCategory")}
              >
                category
              </li>
            </ul>
        ...
        <details className="relative">
          ...
          >
            <span className="flex items-center ml-2">
              ...
              >
                <path
                  d="M12 21C6.48 21 2 16.52 2 12S6.48 3 12 3s10 3 10 12-4.48 12-4.48-12zm0-4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8zm0 4c-1.11 0-2-.9-2-2s.9-2 2 2-.9 2-2 2z"
                  fill={
                    location?.pathname?.split("/")[1] === "questions"
                      ? "#000000"
                      : "currentColor"
